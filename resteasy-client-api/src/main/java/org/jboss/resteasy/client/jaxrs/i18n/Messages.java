...
public interface Messages
{
   ...
   @Message(id = BASE
         + 0, value = "You can only set one of LinkHeaderParam.rel() and LinkHeaderParam.title() for on {0}.{1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 25, value = "Marking file '%s' to be deleted, as it could not be deleted while processing request:")
   ...
   @Message(id = BASE
         + 60, value = "Failed to buffer aborted response. Could not find writer for content-type {0} type: {1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 90, value = "You must define a @Consumes type on your client method or interface, or supply a default")
   String mustDefineConsumesType();

   @Message(id = BASE
         + 95, value = "You must set either LinkHeaderParam.rel() or LinkHeaderParam.title() for on {0}.{1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 123, value = "Please consider updating the version of Apache HttpClient being used.  Version 4.3.6+ is recommended.")
