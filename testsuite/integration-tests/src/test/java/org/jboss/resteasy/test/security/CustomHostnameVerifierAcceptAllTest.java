...
@RunAsClient
public class CustomHostnameVerifierAcceptAllTest extends SSLTestBase {

   private static final Logger LOG = Logger.getLogger(CustomHostnameVerifierAcceptAllTest.class.getName());
