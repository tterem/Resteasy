 ...
 * @tpTestCaseDetails Test for SSL - trusted server
 * @tpSince RESTEasy 3.6.3.Final
 */
@RunWith(Arquillian.class)
@RunAsClient
public class SslBasicTrustedServerTest extends SSLTestBase {

   private static final Logger LOG = Logger.getLogger(SslBasicTrustedServerTest.class.getName());
