 ...
 * @tpTestCaseDetails Test for SSL - untrusted server
 * @tpSince RESTEasy 3.6.3.Final
 */
@RunWith(Arquillian.class)
@RunAsClient
public class SslBasicUntrustedServerTest extends SSLTestBase {

   private static final Logger LOG = Logger.getLogger(SslBasicUntrustedServerTest.class.getName());
