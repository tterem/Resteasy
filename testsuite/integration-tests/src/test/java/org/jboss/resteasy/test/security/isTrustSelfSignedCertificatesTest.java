...
public class isTrustSelfSignedCertificatesTest {
   ...
   private static String SERVER_UNTRUSTED_KEYSTORE_PATH = "src" + FS + "test" + FS + "resources" + FS + "org" + FS + "jboss" + FS + "resteasy" + FS + "test" + FS + "security" + FS + "untrusted.keystore";
   private static final String CLIENT_TRUSTSTORE_PATH = "src" + FS + "test" + FS + "resources" + FS + "org" + FS + "jboss" + FS + "resteasy" + FS + "test" + FS + "security" + FS + "client.truststore";
   ...
   private static void secureServer() throws Exception {
      ...
      SERVER_UNTRUSTED_KEYSTORE_PATH = SERVER_UNTRUSTED_KEYSTORE_PATH.replace("\\","\\\\");
