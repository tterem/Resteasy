 ...
 * @tpTestCaseDetails Test for SSL - unsecured server and disableTrustManager() method
 * @tpSince RESTEasy 3.6.3.Final
 */
@RunWith(Arquillian.class)
@RunAsClient
public class DisableTrustManagerUnsecuredServerTest extends SSLTestBase {

   private static final Logger LOG = Logger.getLogger(DisableTrustManagerUnsecuredServerTest.class.getName());
