...
@RunAsClient
public class HostnameVerificationPolicyAnyTest extends SSLTestBase {

   private static final Logger LOG = Logger.getLogger(HostnameVerificationPolicyAnyTest.class.getName());
