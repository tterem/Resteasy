...
@RunAsClient
public class HostnameVerificationPolicyStrictOkTest {

   protected static final Logger LOG = Logger.getLogger(HostnameVerificationPolicyStrictOkTest.class.getName());
   ...
   public void test() {
      ...
      Response response = client.target("https://" + PortProviderUtil.getHost() + ":8443/war_default/secure/hello").request().get();
