...
@Stateless
public class StatelessEJBwithJaxRsComponents implements StatelessEJBwithJaxRsComponentsInterface {
   ...
   public void setUp(String key) {
      log.info("entering StatelessEJBwithJaxRsComponents.setUp()");
   ...
   /**
    * This is an SLSB. See discussion in ReverseInjectionEJBHolder.test().
    * <p>
   ...
   public boolean test(String key) {
      log.info("entering StatelessEJBwithJaxRsComponents.test(" + key + ")");
   ...
   public Class<?> theClass() {
      return StatelessEJBwithJaxRsComponents.class;
   }
   ...
   public boolean theSame(ReverseInjectionEJBInterface ejb) {
      ...
      if (!StatelessEJBwithJaxRsComponents.class.equals(c)) {
         log.info(ejb + " not instanceof StatelessEJBwithJaxRsComponents: " + c);
         return false;
      }
