...
public class MultipartRelatedOutput extends MultipartOutput{
    ...
    * @param entity the object representing the part's body
    * @param mediaType the Content-Type of the part
    * @param contentId the Content-ID to be used as identification for the current
    * part, optional, if null one will be generated
    * @param contentTransferEncoding The value to be used for the Content-Transfer-Encoding header
