...
abstract public class TestMessagesAbstract extends TestMessagesParent{
   ...
   public void testLocale() throws Exception{
      ...
      Assert.assertEquals(getExpected(BASE+"10","requestMediaType"),Messages.MESSAGES.requestMediaType());
      Assert.assertEquals(getExpected(BASE+"15","unexpected"),Messages.MESSAGES.unexpected());
   }
